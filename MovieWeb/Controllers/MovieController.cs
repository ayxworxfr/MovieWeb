...
namespace MovieWeb.Controllers
{
    public class MovieController : Controller
    {
        ...
        public ActionResult FindMovie(string title)
        {
            ...
            var movies = db.Movies.SingleOrDefault(p => p.Title == title);
            if (movies == null)
            {
                //return Content("没有");
                return Json("没有");
        ...
        [HttpPost]
        public ActionResult FindAllMovie()
        {
        ...
        public ActionResult Create([Bind(Include = "MovieId,Type,Title,Actors,Info,Url,Source,StartTime,Address")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MovieId,Type,Title,Actors,Info,Url,Source,StartTime,Address")] Movie movie)
        {
            if (ModelState.IsValid)
            {
